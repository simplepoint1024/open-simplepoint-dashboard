...
public class AiMcpPublicationInternalController {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(
      AiMcpPublicationInternalController.class
  );

  private static final String TASK_REQUEST_INVALID =
      "AI_MCP_TASK_REQUEST_INVALID";
  ...
  public Map<String, String> invalidTaskRequest(
    ...
    LOG.warn("MCP Task request rejected with {}",
        TASK_REQUEST_INVALID, exception);
    return Map.of("errorCode", TASK_REQUEST_INVALID);
  }
