...
public class FieldScopeController extends BaseController<FieldScopeService, FieldScope, String> {
  ...
  @GetMapping("/catalog")
  @PreAuthorize("hasRole('Administrator') or hasAuthority('field-scope.view') or hasAuthority('field-scope.edit')")
  public Response<Map<String, java.util.List<String>>> catalog() {
