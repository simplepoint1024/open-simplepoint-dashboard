...
/**
 * Standard permission namespaces used by platform, tenant, and personal scopes.
 */
public final class AuthorizationPermissionNamespaces {
  ...
  private AuthorizationPermissionNamespaces() {
  }
}
