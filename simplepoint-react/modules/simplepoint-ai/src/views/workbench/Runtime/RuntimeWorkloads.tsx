      ...
      render: (_: unknown, workload: RuntimeWorkload) => (
        <Space>
          ...
          <Button
            ...
            danger
            size="small"
            disabled={TERMINAL_STATUSES.has(workload.status)}
      ...
      >
        {detail && (
          <Descriptions bordered size="small" column={2}>
            ...
            <Descriptions.Item label="Execution ID" span={2}>{detail.executionId}</Descriptions.Item>
            ...
            <Descriptions.Item label="Lease ID">{detail.leaseId || '-'}</Descriptions.Item>
            <Descriptions.Item label="Fence">{detail.fencingToken}</Descriptions.Item>
            <Descriptions.Item label="Container ID" span={2}>
            ...
            <Descriptions.Item label="Digest" span={2}>{detail.imageDigest}</Descriptions.Item>
