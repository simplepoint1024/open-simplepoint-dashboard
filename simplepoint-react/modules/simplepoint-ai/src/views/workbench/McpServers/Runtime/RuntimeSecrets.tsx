...
const RuntimeSecrets = ({secretsUrl, canManage}: RuntimeSecretsProps) => {
  const {t} = useI18n();
  ...
  }, [createForm, load, message, secretsUrl, t]);
  ...
  }, [load, message, rotateForm, rotatingSecret, secretsUrl, t]);
  ...
  ], [canManage, modal, removeSecret, rotateForm, t]);
      ...
      >
        {loadError && (
          <Alert
            ...
            message={t('ai.runtime.error.secrets.load', 'Runtime Secret 加载失败')}
