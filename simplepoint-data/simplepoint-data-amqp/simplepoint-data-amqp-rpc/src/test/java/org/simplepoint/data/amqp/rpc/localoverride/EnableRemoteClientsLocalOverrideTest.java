...
class EnableRemoteClientsLocalOverrideTest {

  @Test
  void enableRemoteClientsShouldPreferLocalImplementation() {
  ...
  @EnableRemoteClients(basePackageClasses = LocalOverrideApi.class)
