...
@Slf4j
@Component
public final class DefaultDataInitializeManager implements DataInitializeManager {
   ...
   */
  public DefaultDataInitializeManager(
   ...
   */
  public boolean execute(String moduleName, DataInitializeManager.Initializer initializer) {
