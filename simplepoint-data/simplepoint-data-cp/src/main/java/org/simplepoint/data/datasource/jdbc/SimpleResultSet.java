...
/**
 * A simple implementation of the ResultSet interface.
 * This class provides a wrapper around a delegate ResultSet,
 * enabling custom handling or extensions of standard ResultSet functionality.
 */
...
public class SimpleResultSet implements ResultSet {
  ...
  /**
   * Constructs a new SimpleResultSet instance.
   * This constructor initializes the instance with a delegate ResultSet.
   *
   * @param delegate the ResultSet instance to delegate calls to
   */
  public SimpleResultSet(ResultSet delegate) {
  ...
  public ResultSetMetaData getMetaData() throws SQLException {
    return new SimpleResultSetMetaData(delegate.getMetaData());
  }
  ...
  public Statement getStatement() throws SQLException {
    return new SimpleStatement(delegate.getStatement());
  }
  ...
  public <T> T unwrap(Class<T> face) throws SQLException {
    return this.delegate.unwrap(face);
  }

  @Override
  public boolean isWrapperFor(Class<?> face) throws SQLException {
    return this.delegate.isWrapperFor(face);
  }
