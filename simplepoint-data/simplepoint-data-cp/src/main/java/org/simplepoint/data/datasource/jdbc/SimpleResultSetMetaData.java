...
/**
 * A simple implementation of the ResultSetMetaData interface.
 * This class provides metadata about the columns of a ResultSet,
 * including details such as column names, types, and other attributes.
 */
public class SimpleResultSetMetaData implements ResultSetMetaData {
  private final ResultSetMetaData delegate;

  /**
   * Constructs a new SimpleResultSetMetaData instance.
   * This constructor initializes the instance with a delegate ResultSetMetaData.
   *
   * @param delegate the ResultSetMetaData instance to delegate calls to
   */
  public SimpleResultSetMetaData(ResultSetMetaData delegate) {
