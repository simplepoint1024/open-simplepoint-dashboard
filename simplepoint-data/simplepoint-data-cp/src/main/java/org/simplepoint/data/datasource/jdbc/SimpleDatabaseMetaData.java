...
/**
 * A simple implementation of the DatabaseMetaData interface.
 * This class provides metadata information about the database,
 * including details about its tables, columns, and supported features.
 */
public class SimpleDatabaseMetaData implements DatabaseMetaData {
  private final DatabaseMetaData delegate;

  /**
   * Constructs a new SimpleDatabaseMetaData instance.
   * This constructor initializes the instance with a delegate DatabaseMetaData.
   *
   * @param delegate the DatabaseMetaData instance to delegate calls to
   */
  public SimpleDatabaseMetaData(DatabaseMetaData delegate) {
  ...
  public ResultSet getProcedures(String catalog, String schemaPattern, String procedureNamePattern)
    ...
    return new SimpleResultSet(
        delegate.getProcedures(catalog, schemaPattern, procedureNamePattern));
  }
  ...
  public ResultSet getProcedureColumns(String catalog, String schemaPattern,
      ...
      throws SQLException {
    return new SimpleResultSet(
        this.delegate.getProcedureColumns(catalog, schemaPattern, procedureNamePattern,
            columnNamePattern));
  }
  ...
  public ResultSet getTables(String catalog, String schemaPattern, String tableNamePattern,
    ...
    return new SimpleResultSet(
        this.delegate.getTables(catalog, schemaPattern, tableNamePattern, types));
  }

  @Override
  public ResultSet getSchemas() throws SQLException {
    return new SimpleResultSet(this.delegate.getSchemas());
  }

  @Override
  public ResultSet getSchemas(String catalog, String schemaPattern) throws SQLException {
    return new SimpleResultSet(this.delegate.getSchemas(catalog, schemaPattern));
  }

  @Override
  public ResultSet getCatalogs() throws SQLException {
    return new SimpleResultSet(this.delegate.getCatalogs());
  }

  @Override
  public ResultSet getTableTypes() throws SQLException {
    return new SimpleResultSet(this.delegate.getTableTypes());
  }
  ...
  public ResultSet getColumns(String catalog, String schemaPattern, String tableNamePattern,
    ...
    return new SimpleResultSet(
        this.delegate.getColumns(catalog, schemaPattern, tableNamePattern, columnNamePattern));
  }
  ...
  public ResultSet getColumnPrivileges(String catalog, String schema, String table,
                                       String columnNamePattern) throws SQLException {
    return new SimpleResultSet(
        this.delegate.getColumnPrivileges(catalog, schema, table, columnNamePattern));
  }
  ...
  public ResultSet getTablePrivileges(String catalog, String schemaPattern, String tableNamePattern)
      throws SQLException {
    return new SimpleResultSet(
        this.delegate.getTablePrivileges(catalog, schemaPattern, tableNamePattern));
  }
  ...
  public ResultSet getBestRowIdentifier(String catalog, String schema, String table, int scope,
    ...
    return new SimpleResultSet(
        this.delegate.getBestRowIdentifier(catalog, schema, table, scope, nullable));
  }

  @Override
  public ResultSet getVersionColumns(String catalog, String schema, String table)
      throws SQLException {
    return new SimpleResultSet(this.delegate.getVersionColumns(catalog, schema, table));
  }

  @Override
  public ResultSet getPrimaryKeys(String catalog, String schema, String table) throws SQLException {
    return new SimpleResultSet(this.delegate.getPrimaryKeys(catalog, schema, table));
  }

  @Override
  public ResultSet getImportedKeys(String catalog, String schema, String table)
      throws SQLException {
    return new SimpleResultSet(this.delegate.getImportedKeys(catalog, schema, table));
  }

  @Override
  public ResultSet getExportedKeys(String catalog, String schema, String table)
      throws SQLException {
    return new SimpleResultSet(this.delegate.getExportedKeys(catalog, schema, table));
  }
  ...
  public ResultSet getCrossReference(String parentCatalog, String parentSchema, String parentTable,
    ...
    return new SimpleResultSet(
        this.delegate.getCrossReference(parentCatalog, parentSchema, parentTable, foreignCatalog,
            foreignSchema, foreignTable));
  }

  @Override
  public ResultSet getTypeInfo() throws SQLException {
    return new SimpleResultSet(this.delegate.getTypeInfo());
  }
  ...
  public ResultSet getIndexInfo(String catalog, String schema, String table, boolean unique,
    ...
    return new SimpleResultSet(
        this.delegate.getIndexInfo(catalog, schema, table, unique, approximate));
  }
  ...
  public ResultSet getUDTs(String catalog, String schemaPattern, String typeNamePattern,
    ...
    return new SimpleResultSet(
        this.delegate.getUDTs(catalog, schemaPattern, typeNamePattern, types));
  }
  ...
  public ResultSet getSuperTypes(String catalog, String schemaPattern, String typeNamePattern)
      throws SQLException {
    return new SimpleResultSet(
        this.delegate.getSuperTypes(catalog, schemaPattern, typeNamePattern));
  }
  ...
  public ResultSet getSuperTables(String catalog, String schemaPattern, String tableNamePattern)
      throws SQLException {
    return new SimpleResultSet(
        this.delegate.getSuperTables(catalog, schemaPattern, tableNamePattern));
  }
  ...
  public ResultSet getAttributes(String catalog, String schemaPattern, String typeNamePattern,
    ...
    return new SimpleResultSet(
        this.delegate.getAttributes(catalog, schemaPattern, typeNamePattern, attributeNamePattern));
  }
  ...
  public ResultSet getClientInfoProperties() throws SQLException {
    return new SimpleResultSet(this.delegate.getClientInfoProperties());
  }
  ...
  public ResultSet getFunctions(String catalog, String schemaPattern, String functionNamePattern)
      throws SQLException {
    return new SimpleResultSet(
        this.delegate.getFunctions(catalog, schemaPattern, functionNamePattern));
  }
  ...
  public ResultSet getFunctionColumns(String catalog, String schemaPattern,
      ...
      throws SQLException {
    return new SimpleResultSet(
        this.delegate.getFunctionColumns(catalog, schemaPattern, functionNamePattern,
            columnNamePattern));
  }
  ...
  public ResultSet getPseudoColumns(String catalog, String schemaPattern, String tableNamePattern,
                                    String columnNamePattern) throws SQLException {
    return new SimpleResultSet(
        this.delegate.getPseudoColumns(catalog, schemaPattern, tableNamePattern,
            columnNamePattern));
  }
