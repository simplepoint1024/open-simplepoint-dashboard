...
/**
 * Immutable MCP Prompt capability pinned by one Skill version.
 */
@Data
@Entity
@Table(
    name = "simpoint_ai_skill_prompt_bindings",
    indexes = {
        @Index(
            name = "idx_simpoint_ai_skill_prompt_binding_version",
            columnList = "skill_version_id"
        ),
        @Index(
            name = "idx_simpoint_ai_skill_prompt_binding_scope",
...
@NoArgsConstructor
@Schema(title = "AI Skill Prompt Binding")
public class AiSkillPromptBinding extends BaseEntityImpl<String> {
  ...
  @Column(name = "prompt_name", length = 128, nullable = false)
  private String promptName;

  @Column(name = "prompt_alias", length = 64, nullable = false)
