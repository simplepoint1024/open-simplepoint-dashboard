...
import org.simplepoint.plugin.dna.core.service.dialect.type.PrestoJdbcTypeMapping;

/**
 * JDBC dialect for PrestoDB query engine.
 *
 * <p>Presto uses a {@code catalog.schema.table} namespace. Catalogs correspond to
 * connectors (e.g., {@code hive}, {@code mysql}, {@code tpch}). Schemas live within
 * catalogs. DDL support is limited and connector-dependent.</p>
 */
public class PrestoJdbcDatabaseDialect extends AbstractJdbcDatabaseDialect {
  ...
  public String description() {
    return "PrestoDB distributed SQL query engine dialect";
  }
  ...
  public JdbcTypeMapping typeMapping() {
    return PrestoJdbcTypeMapping.INSTANCE;
  }
  ...
  public boolean supports(final SupportContext context) {
    ...
    return databaseType.contains("presto")
        || driverClassName.contains("presto")
        || productName.contains("presto");
  }
  ...
  public String buildAddConstraintSql(
    ...
    throw new UnsupportedOperationException("Presto 不支持约束管理");
  }
