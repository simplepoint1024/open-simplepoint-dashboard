...
public class FederationCatalogController
  ...
  @Operation(summary = "分页查询联邦目录", description = "根据条件分页查询联邦目录定义")
  ...
  @Operation(summary = "新增联邦目录", description = "新增一个联邦目录定义")
  ...
  @Operation(summary = "修改联邦目录", description = "修改一个已存在的联邦目录定义")
  ...
  @Operation(summary = "删除联邦目录", description = "根据 ID 集合删除联邦目录定义")
