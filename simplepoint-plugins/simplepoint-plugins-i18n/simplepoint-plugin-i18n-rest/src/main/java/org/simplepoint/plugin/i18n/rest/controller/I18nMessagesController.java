...
public class I18nMessagesController extends BaseController<I18nMessageService, Message, String> {
   ...
   */
  @GetMapping
  @PreAuthorize("hasRole('Administrator') or hasAuthority('messages.view')")
   ...
   */
  @PostMapping
  @PreAuthorize("hasRole('Administrator') or hasAuthority('messages.create')")
   ...
   */
  @PutMapping
  @PreAuthorize("hasRole('Administrator') or hasAuthority('messages.edit')")
   ...
   */
  @DeleteMapping
  @PreAuthorize("hasRole('Administrator') or hasAuthority('messages.delete')")
