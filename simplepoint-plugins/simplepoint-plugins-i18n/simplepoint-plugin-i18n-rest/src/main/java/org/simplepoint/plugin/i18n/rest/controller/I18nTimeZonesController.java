...
public class I18nTimeZonesController extends BaseController<I18nTimeZoneService, TimeZone, String> {
   ...
   */
  @GetMapping
  @PreAuthorize("hasAuthority('i18n.timezones.view')")
   ...
   */
  @PostMapping
  @PreAuthorize("hasAuthority('i18n.timezones.add')")
   ...
   */
  @PutMapping
  @PreAuthorize("hasAuthority('i18n.timezones.edit')")
   ...
   */
  @DeleteMapping
  @PreAuthorize("hasAuthority('i18n.timezones.delete')")
