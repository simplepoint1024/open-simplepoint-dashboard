...
public class I18nNamespaceController extends BaseController<I18nNamespaceService, Namespace, String> {
   ...
   */
  @GetMapping
  @PreAuthorize("hasAuthority('i18n.namespaces.view')")
   ...
   */
  @PostMapping
  @PreAuthorize("hasAuthority('i18n.namespaces.add')")
   ...
   */
  @PutMapping
  @PreAuthorize("hasAuthority('i18n.namespaces.edit')")
   ...
   */
  @DeleteMapping
  @PreAuthorize("hasAuthority('i18n.namespaces.delete')")
