...
public class I18nCountriesController extends BaseController<I18nCountriesService, Countries, String> {
   ...
   */
  @GetMapping
  @PreAuthorize("hasRole('Administrator') or hasAuthority('countries.view')")
   ...
   */
  @PostMapping
  @PreAuthorize("hasRole('Administrator') or hasAuthority('countries.create')")
   ...
   */
  @PutMapping
  @PreAuthorize("hasRole('Administrator') or hasAuthority('countries.edit')")
   ...
   */
  @DeleteMapping
  @PreAuthorize("hasRole('Administrator') or hasAuthority('countries.delete')")
