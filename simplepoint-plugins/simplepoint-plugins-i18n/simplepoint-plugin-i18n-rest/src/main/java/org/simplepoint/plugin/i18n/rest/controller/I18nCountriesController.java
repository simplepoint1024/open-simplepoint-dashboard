...
public class I18nCountriesController extends BaseController<I18nCountriesService, Countries, String> {
   ...
   */
  @GetMapping
  @PreAuthorize("hasAuthority('menu:i18n:countries:view')")
   ...
   */
  @PostMapping
  @PreAuthorize("hasAuthority('menu:i18n:countries:add')")
   ...
   */
  @PutMapping
  @PreAuthorize("hasAuthority('menu:i18n:countries:edit')")
   ...
   */
  @DeleteMapping
  @PreAuthorize("hasAuthority('menu:i18n:countries:delete')")
