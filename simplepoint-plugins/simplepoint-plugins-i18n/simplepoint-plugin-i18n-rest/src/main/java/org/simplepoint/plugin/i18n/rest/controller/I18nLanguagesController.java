...
public class I18nLanguagesController extends BaseController<I18nLanguageService, Language, String> {
   ...
   */
  @GetMapping
  @PreAuthorize("hasAuthority('i18n.languages.view')")
   ...
   */
  @PostMapping
  @PreAuthorize("hasAuthority('i18n.languages.add')")
   ...
   */
  @PutMapping
  @PreAuthorize("hasAuthority('i18n.languages.edit')")
   ...
   */
  @DeleteMapping
  @PreAuthorize("hasAuthority('i18n.languages.delete')")
