...
public class I18nLanguagesController extends BaseController<I18nLanguageService, Language, String> {
   ...
   */
  @GetMapping
  @PreAuthorize("hasRole('Administrator') or hasAuthority('languages.view')")
   ...
   */
  @PostMapping
  @PreAuthorize("hasRole('Administrator') or hasAuthority('languages.create')")
   ...
   */
  @PutMapping
  @PreAuthorize("hasRole('Administrator') or hasAuthority('languages.edit')")
   ...
   */
  @DeleteMapping
  @PreAuthorize("hasRole('Administrator') or hasAuthority('languages.delete')")
