...
public class I18nRegionsController extends BaseController<I18nRegionService, Region, String> {
   ...
   */
  @GetMapping
  @PreAuthorize("hasRole('Administrator') or hasAuthority('regions.view')")
   ...
   */
  @PostMapping
  @PreAuthorize("hasRole('Administrator') or hasAuthority('regions.create')")
   ...
   */
  @PutMapping
  @PreAuthorize("hasRole('Administrator') or hasAuthority('regions.edit')")
   ...
   */
  @DeleteMapping
  @PreAuthorize("hasRole('Administrator') or hasAuthority('regions.delete')")
