 ...
 *
 * <p>This controller provides CRUD operations for {@link Actions} objects,
...
public class ButtonController extends BaseController<ButtonService, Actions, String> {
  /**
  ...
  public Response<Page<Actions>> limit(@RequestParam Map<String, String> attributes,
                                       Pageable pageable)
      throws Exception {
    return limit(service.limit(attributes, pageable), Actions.class);
  }

  /**
   * Adds a new button record.
   *
   * @param data the {@link Actions} instance to be added
  ...
  public Response<Actions> add(@RequestBody Actions data) throws Exception {
   ...
   *
   * @param data the {@link Actions} instance containing updated information
  ...
  public Response<Actions> modify(@RequestBody Actions data) throws Exception {
