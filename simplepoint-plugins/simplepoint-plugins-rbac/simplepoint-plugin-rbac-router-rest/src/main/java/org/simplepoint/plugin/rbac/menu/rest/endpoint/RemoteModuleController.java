...
public class RemoteModuleController
    extends BaseController<RemoteModuleService, MicroModule, String> {
  ...
  public Response<Page<MicroModuleItemVo>> limit(
    ...
    return Response.limit(new PageImpl<>(list), MicroModuleItemVo.class);
  }
}
